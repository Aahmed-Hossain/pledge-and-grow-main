          ...
          <div className="col-lg-5 valign rest">
            <div className="cont">
              ...
              <div className="feat mt-80">
                <div className="item-flex d-flex align-items-center mb-30 wow fadeInUp" data-wow-delay=".4s">
                  <div>
                    <div  className="icon-img-50">
                      <img src={`/${lightMode ? 'light' : 'dark'}/assets/imgs/serv-icons/0.png`} alt="" />
                    </div>
                  </div>
                  <div  className="cont ml-30 mt-10 ">
                ...
                <div className="item-flex d-flex align-items-center wow fadeInUp" data-wow-delay=".8s">
                  ...
                  <div className="cont ml-30">
                    <h6>Solutions Personnalisées</h6>
                    {/* <p className="fz-15">Adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                    </p> */}
                  </div>
                </div>
                ...
                <div  className="item-flex d-flex align-items-center wow fadeInUp mt-20" data-wow-delay=".8s">
                  <div>
                    <div className="icon-img-50">
                      <img src={`/${lightMode ? 'light' : 'dark'}/assets/imgs/serv-icons/0.png`} alt="" />
                    </div>
                  ...
                  <div className="cont ml-30">
                    <h6>Économie de coûts et de temps</h6>
                    {/* <p className="fz-15">Adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                    </p> */}
                  </div>
                </div>
