              ...
              <div className="row">
                <div className="col-lg-9">
                  <div className="flex">
                    ...
                    <div className="cont">
                      <h6 className="line-height-1">Qualité et Innovation</h6>
                      {/* <span className="fz-12 ls1 text-u mb-15">14 sept 2021, 07:00 AM</span> */}
                      <p className="fz-14">Nous nous engageons à fournir des solutions blockchain de haute qualité, en utilisant les technologies les plus avancées.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-lg-9">
                  <div className="flex">
                    ...
                    <div className="cont">
                      ...
                      {/* <span className="fz-12 ls1 text-u mb-15">14 sept 2021, 07:00 AM</span> */}
                      <p className="fz-14">
                      Nous assurons une communication claire et transparente sur l'avancement des projets et les résultats obtenus.
                      </p>
                    </div>
                  </div>
                </div>
