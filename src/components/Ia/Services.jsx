...
//= Data
import data from '@/data/IA/services.json';
          ...
          <div className="row">
            <div className="col-lg-5">
              ...
              <h2 className="d-rotate wow">
                <span className="rotate-text">Pourquoi Choisir Pledge and Grow ?</span>
              </h2>
            </div>
            <div className="col-lg-4 d-flex align-items-center">
              <div className="text d-rotate wow md-mb30">
                <p className="rotate-text">Nos Services de Maintenance pour l'Intégration de l'IA.</p>
              </div>
            </div>
