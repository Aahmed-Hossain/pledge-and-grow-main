        ...
        <div className="row">
          ...
          <div className="col-lg-2 md-mb50">
            ...
            <ul className="rest social-text">
              ...
              <li>
                <a href="#0">Politiques de confidentialité</a>
              </li>
              <li>
                <a href="#0">Politique d'utilisation des cookies</a>
              </li>
              <li>
                <a href="#0">Conditions générales de vente et d'utilisation</a>
              </li>
              <li>
                <a href="#0">Politique de remboursement</a>
              </li>
            </ul>
          </div>
