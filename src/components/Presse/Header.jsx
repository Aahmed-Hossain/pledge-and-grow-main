...
function Header() {
  ...
  return (
    <header className="header-freelancer full-height bord-thin-bottom valign position-re" data-overlay-dark="5" data-scroll-index="0">
        ...
        <div className="row">
          <div className="col-lg-7">
            <div className="caption">
              ...
              <h1 className="fz-60">Espace communication et relation presse de Simplébo</h1>
              <div className="row mt-50">
                <div className="col-lg-3 cal-act order2">
                  <Link href="https://www.simplebo.fr" className="butn-circle d-flex align-items-center text-center">
                    <div className="full-width">
                      ...
                      <span className="full-width">Demande d'information</span>
                    </div>
                ...
                <div className="col-lg-8 offset-lg-1 valign order1 md-mb50">
                  <p className="fz-16">Toute l'actualité de l'agence web Simplébo.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="bg-img" data-background="/dark/assets/imgs/presse/h2.png"></div>
    </header>
  )
}
