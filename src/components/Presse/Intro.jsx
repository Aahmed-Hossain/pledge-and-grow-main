      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-lg-5 valign md-hide">
            <h2 className="max-text" data-text="Communiqués de presse de la Start-up Simplébo"> Communiqués de presse de la Start-up Simplébo</h2>
          </div>
          <div className="col-lg-3 order2">
            <div className="img">
              <img src="/dark/assets/imgs/presse/h2.png" alt="" className="parallax" data-speed="0.01" />
