...
//= Data
import data from '@/data/Presse/services.json';
          ...
          <div className="row">
            <div className="col-lg-7">
              <div className="position-re">
                ...
                <h2 className="fz-40">Sélection de parutions récentes dans la presse</h2>
              </div>
            </div>
        ...
        <div style={{display: 'flex', flexDirection: 'row-reverse' , alignItems: 'center', alignContent: 'center' ,justifyContent: 'center'}} className="row">
          {
            data.map((item, index) => (
              <div  className="col-lg-6" key={item.id}>
                <div  style={{height: '20rem'}} className={`serv-item d-flex ${index !== data.length - 1 ? 'mb-30' : ''} radius-10`}>
                  <div className="">
                    <img style={{width: '6rem'}} src={`/${lightMode ? 'light' : 'dark'}/${item.image}`} alt="" />
                  </div>
                  <div className="ml-60">
                    ...
                    <div className="vew-all mt-40">
                  <Link href="/dark/page-services">Lire l'article
                    <span>
                      <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
