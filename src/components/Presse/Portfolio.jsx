...
//= Data
import data from '@/data/Presse/portfolio.json';
          ...
          <div className="row">
            <div className="col-lg-7">
              <div className="position-re">
                ...
                <h2 className="fz-40">Podcasts : les dirigeants de Simplébo à l'honneur</h2>
              </div>
            </div>
              ...
              <div className={`col-lg-${index > 1 ? '4' : '6'}`} key={item.id}>
                <div className="item mt-30">
                  ...
                  <div className="cont mt-30 d-flex">
                    <div>
                      <h6 className="line-height-1"><Link href="#">{item.title}</Link></h6>
                    </div>
