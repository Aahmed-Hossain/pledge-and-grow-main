        ...
        <div className="sec-lg-head section-padding">
          <div className="row ontop">
            <div className="col-11 d-flex align-items-center">
             ...
             <a href="https://www.youtube.com/watch?v=FfITXaJnKC4"   onClick={openVideo} className="butn-circle d-flex align-items-center text-center m-auto" >
                  <div  className="full-width">
                    ...
                    <span className="full-width">Notre histoire</span>
                  </div>
