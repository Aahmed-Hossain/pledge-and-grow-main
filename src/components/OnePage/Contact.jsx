        ...
        <div className="row">
          <div className="col-lg-5">
            <div className="sec-lg-head md-mb80">
              ...
              Contactez-nous</h6>
              <h2 className="fz-50">Pledge and Grow  Application Mobile!</h2>
              <p className="fz-15 mt-10"> dès aujourd'hui pour discuter de votre projet et découvrir comment nous pouvons vous aider à créer une application mobile réussie.</p>
